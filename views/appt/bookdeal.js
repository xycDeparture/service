...
import styles from './bookdeal.scss'
...
export default class BookDealListView extends React.Component {
    static propTypes = {
            ...
            <div className={styles.main}>
                ...
                <div className={styles.apptCont} id="apptCont">
                    ...
                    this.props.serviceList.map(item => {
                        return (
                            <div className={styles.apptOne} key={item.get('sid')} onClick={ () => { this.checkApptDetail(item.get('sid')) } }>
                                ...
                                <div className={styles.apptInfos}>
                                    <div className={styles.apptName}>
                                        <span>{item.get('name')}</span> {item.get('corp_name') || ''}
                                    </div>
                                    <div className={styles.apptItem}>
                                        <span>业务类型</span> {item.get('service_type')}
                                    </div>
                                    <div className={styles.apptItem}>
                                ...
                                <div className={styles.apptDetail}></div>
                            </div>
                        )
                    })
                        :
